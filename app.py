...
import pandas as pd
import preprocessor  # Import preprocessor module
import helper
...
# Call the preprocess function from preprocessor module
...
if user_menu == 'Athlete-wise Analysis':
    ...
    fig = ff.create_distplot([x1, x2, x3, x4], ['Overall Age', 'Gold Medlistt', 'Silver Medlist', 'Bronze Medlist'], show_hist=False, show_rug=False)
